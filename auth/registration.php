...
// Variables pour afficher le message d'alerte
$alertMessage = "";
$showAlert = false;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (!empty($_POST['nom']) && !empty($_POST['telephone']) && !empty($_POST['Email']) && !empty($_POST['motdepasse'])) {
        ...
        if ($stmt->execute()) {
            ...
            $alertMessage = "Erreur lors de l'inscription. Veuillez réessayer.";
            $showAlert = true;
        }
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        togglePassword.addEventListener("click", function () {
            if (passwordField.type === "password") {
                ...
                togglePassword.textContent = "👁️"; // Correctement fermer la chaîne
            } else {
                passwordField.type = "password";
                togglePassword.textContent = "👁️"; // Ajouter la logique de retour à l'icône œil
            }
        });
    });
</script>
